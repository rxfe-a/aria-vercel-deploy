              ...
              case "worker":
                {
                  const e = [
                    ...
                    .join(",");
                  (f.body = `if (!self.__uv && self.importScripts) { ${c.createJsInject(
                    this.address,
